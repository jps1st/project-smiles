 ...
 */
public class F14_src implements JRDataSource {
     ...
     */
    public F14_src(int printingSequenceNum, String gender, BedLoading teacherLoad) {
    ...
    public Object getFieldValue(JRField jrf) throws JRException {
        ...
        if (n.equals("logo1")) {
            return JRDataSource.class.getResourceAsStream("/reports/bed/generic/logos/cjcn.png");// = this.getClass().getResourceAsStream("/reports/bed/generic/logos/cjc.png");
        }
        if (n.equals("logo2")) {
